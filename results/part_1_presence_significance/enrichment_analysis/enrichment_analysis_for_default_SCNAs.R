################################################################################
# title: 'Enrichment Analysis for default SCNAs'
...
saveRDS(working_figure,
        file = "results/part_1_presence_significance/enrichment_analysis/enrichment_line_grapgh_default.rds")
  
ggsave(filename = "enrichment_line_grapgh_default.png",
       plot = working_figure,
...
saveRDS(working_figure,
        file = "results/part_1_presence_significance/enrichment_analysis/enrichment_line_grapgh_splited_default.rds")
